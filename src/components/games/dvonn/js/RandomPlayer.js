...
// public methods
  ...
  this.move = function () {
    ...
    if (_engine.phase() === Phase.PUT_DVONN_PIECE) {
      move = new Move(Phase.PUT_DVONN_PIECE, _engine.current_color(), this.put_dvonn_piece());
    } else if (_engine.phase() === Phase.PUT_PIECE) {
      move = new Move(Phase.PUT_PIECE, _engine.current_color(), this.put_piece());
      ...
      if (result.ok) {
        ...
        move = new Move(Phase.MOVE_STACK, _engine.current_color(), result.origin,
