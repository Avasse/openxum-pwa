...
// private methods
    ...
    var init_search = function () {
        root = new Node(engine, null, null, engine.get_possible_move_list());
    };
    ...
    var simulate_one_game_from_root = function () {
        ...
        if (current === null || !current.getEngine().is_finished()) {
            ...
            var newNode = new Node(newEngine, current, move, newEngine.get_possible_move_list());
